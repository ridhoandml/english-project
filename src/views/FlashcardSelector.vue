<template>
  <div class="min-h-screen flex flex-col items-center justify-center gap-4 p-4">
    ...
    <div v-else class="flex gap-2 items-center">
      <h3>Save progress with</h3>
      <button class="flex items-center justify-center gap-2 px-2 py-1 border border-white text-white rounded cursor-pointer" @click="signInWithGoogle">
        <span> Login </span>
